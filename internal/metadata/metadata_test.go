	...
	tests := []struct {
		...
		},
		{
			...
			meta: Metadata{
				...
				Season:        1,
				Episodes:      []int{1},
				EpisodeTitles: []string{strings.Repeat("AVeryLongEpisodeTitle", 15)}, // > 245 chars
				Resolution:    "1080p",
			},
	...
	tests := []struct {
	...
	}{
		{
			...
			meta: Metadata{
				...
				Season:        1,
				Episodes:      []int{1},
				EpisodeTitles: []string{"Chapter 1"},
				Date:          "2019-11-12",
				Resolution:    "2160p",
				Service:       "DSNP",
				Source:        "WEB-DL",
		...
		},
		{
			...
			meta: Metadata{
				...
				Season:        0,
				Episodes:      []int{101},
				EpisodeTitles: []string{"The Director and the Jedi"},
				Date:          "2020-05-04",
				Resolution:    "1080p",
				Group:         "PAARSEX",
				IsTV:          true,
	...
	tests := []struct {
		...
		},
		{
			...
			meta: Metadata{
				...
				Season:        0,
				Episodes:      []int{5},
				EpisodeTitles: []string{"Title of the Episode"},
				Source:        "BD",
				Resolution:    "1080p",
				VideoCodec:    "HEVC",
				AudioCodec:    "FLAC",
